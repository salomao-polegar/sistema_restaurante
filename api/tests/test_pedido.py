...
def test_produtos_no_pedido(mysql_repo):
    ...
    adicionar_produto1 = domain.ProdutoNoPedido(pedido = 1, produto = 1, quantidade = 2)
    adicionar_produto2 = domain.ProdutoNoPedido(pedido = 1, produto = 1, quantidade = 7)
    ...
    todos_produtos_pedido = produto_pedido_svc.produtos_no_pedido(1)
    ...
    # TODO: Continuar a implementação dos testes
